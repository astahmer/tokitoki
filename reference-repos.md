...
| Repo | Path | Why |
|------|------|-----|
| robinebers/openusage | ~/.references/openusage | UI/UX benchmark for menubar usage apps: status-bar template-image rendering (MenuBarStripRenderer), popover layout, palette |
| steipete/CodexBar | ~/.references/codexbar | Rich macOS quota menu, usage history charts, cost dashboards, account compaction, and provider/API-key settings patterns |
